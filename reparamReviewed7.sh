...
python reparamerteriser.py name:reConf11 ant:modAntFile7.txt runs:200 reconnect ICReview powerLaw slurm meth:particle_swarm_ridiculous removeHardCoded2